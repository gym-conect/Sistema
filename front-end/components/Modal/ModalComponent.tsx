      ...
      >
        <Fade in={openModal}>
          <Box className={claasBoxModal}>
            <header
              style={{ zIndex: 999, backgroundColor: "#1DB954" }}
              className={`sticky !z-99999  shadow-sm text-white p-2 dark:text-stroke font-medium text-lg overflow-y-auto w-full flex  justify-between top-0 right-0 dark:bg-black`}
            >
              {header ? (
