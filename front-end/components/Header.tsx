...
const Header: FC<HeaderProps> = ({ onLogout }) => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-40 h-14 bg-[#1DB954] shadow-md flex items-center px-6">
      {/* Logo / Título */}
      ...
      {/* Menu horizontal */}
      <div className="ml-8 hidden md:flex items-center gap-6 text-white text-sm">
        <Link
          href="/inicio"
